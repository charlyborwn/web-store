...
public class CheckCreatorImpl implements CheckCreator {
    ...
    private void addTitlePage(Document document, String name, String surname, LocalDateTime date) throws DocumentException {
        ...
        preface.add(new Paragraph("Shopping Check MyCompany web-store", catFont));
        addEmptyLine(preface, 1);
    ...
    private void addContent(Document document, String name, String surname, String phone, String address,
        ...
        Anchor anchor = new Anchor("Order information", catFont);
        anchor.setName("Order information");
        Chapter chapter = new Chapter(new Paragraph(anchor), 1);

        Paragraph paragraph = new Paragraph("Main buyer information", subFont);
        ...
        paragraph = new Paragraph("Address information", subFont);
        ...
        paragraph = new Paragraph("Delivering information and payment", subFont);
        section = chapter.addSection(paragraph);
        ...
        paragraph = new Paragraph("Summary price", subFont);
        section = chapter.addSection(paragraph);
